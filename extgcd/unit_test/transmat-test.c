...
{
	if( rf[0] != 2898) { printf("f[0] fails.\n"); return -1; }
	if( rf[1] != 4092) { printf("f[1] fails.\n"); return -1; }
	if( rf[2] != 1754) { printf("f[2] fails.\n"); return -1; }
	if( rf[3] != 0)    { printf("f[3] fails.\n"); return -1; }

	if( rg[0] != 1698) { printf("g[0] fails.\n"); return -1; }
	if( rg[1] != 728)  { printf("g[1] fails.\n"); return -1; }
	if( rg[2] != 329)  { printf("g[2] fails.\n"); return -1; }
	if( rg[3] != 0)    { printf("g[3] fails.\n"); return -1; }
